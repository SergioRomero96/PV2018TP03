...
public class GestorRectangulo {
  ...
  */
   ...
   /**
    * El metodo requiere dos variables de ingreso para poder calcular el area
    * @param b 
    * @param h 
    * @return 
    */
    ...
    */
    ...
    /**
     * Permite cargarDatos por teclado
     */
    public void cargarDatos(){
       TablaRectangulo obj1=new TablaRectangulo(3,4,calcularPunto(3,4),calcularArea(3,4),calcularPerimetro(3,4),0);
       TablaRectangulo obj2=new TablaRectangulo(5,3,calcularPunto(5,3),calcularArea(3,5),calcularPerimetro(3,5),1);
       TablaRectangulo obj3=new TablaRectangulo(11,8,calcularPunto(11,8),calcularArea(8,11),calcularPerimetro(8,11),2); 
       TablaRectangulo obj4=new TablaRectangulo(12,5,calcularPunto(12,5),calcularArea(5,12),calcularPerimetro(5,12),3);
       TablaRectangulo obj5=new TablaRectangulo(8,9,calcularPunto(8,9),calcularArea(9,8),calcularPerimetro(9,8),4);
    ...
    /**permite mostrar por pantalla los objetos que estan alamacenados en el ArrayList
    **/
        ...
        for(TablaRectangulo a:lista){
            System.out.println(a.getID()+"\t\t"+a.getBase()+"\t\t"+a.getAltura()+"\t\t"+a.getPunto()+"\t\t"+a.getSuperficie()+"\t\t\t"+a.getPerimetro());
            i++;
        }
    }
        /**
         * Permite eliminar un numero de triangulo especificado por el usuario
         */
    public void eliminarTriangulo(){
        Scanner input=new Scanner(System.in);
        int i;char op;
     do{
        System.out.println("Ingrese el numero de rectangulo que desea eliminar");
        i=input.nextInt();
